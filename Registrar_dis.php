...
{
    if(isset($_POST['nombre'],$_POST['apellido'], $_POST['discapacidad'],$_POST['genero'],$_POST['fnacimiento'],$_POST['edad'],$_POST['telefono']
    ...
    && !empty($_POST['localidad']) && !empty($_POST['cp']) && !empty($_POST['direccion']) && !empty($_POST['email']) && !empty($_POST['password']))
    {
        ...
        if(filter_var($email, FILTER_VALIDATE_EMAIL))
        {
            ...
            if($stmt->rowCount() == 0)
            {
                $sql = "insert into discapacitados (nombre, apellido, discapacidad, genero, fnacimiento, edad, telefono, estado, municipio,
                localidad, cp, direccion, email, `password`, created_at,updated_at)
                values(:vnombre,:vapellido,:vdiscapacidad,:vgenero,:vfnacimiento,:vedad,:vtelefono,:vestado,
    ...
    else
    {
        ...
        if(!isset($_POST['discpacidad']) || empty($_POST['discapacidad']))
        {
            $errors[] = 'La discapacidad es requerido';
        }
        else
        {
            $valdiscapacidad = $_POST['discapacidad'];
        }
...
<div class="col-md-4">
<label for="validationDefault03" class="form-label">Discapacidad</label>
<select class="form-select" name="discapacidad" id="validationDefault03" required>
  ...
  <option>Visual y Auditiva</option>
  <option>Visual y Motriz</option>
  <option>Visual y Mental</option>
  <option>Visual y Verbal</option>
  <option>Auditiva y Motriz</option>
  <option>Auditiva y Mental</option>
  <option>Auditiva y Verbal</option>
  <option>Motriz y Mental</option>
  <option>Motriz y Verbal</option>
  <option>Verbal y Mental</option>
</select>
</div>

<div class="col-md-4">
<label for="validationDefault03" class="form-label">Género</label>
<select class="form-select" name="genero" id="validationDefault04" required>
  <option selected disabled value="">Selecciona...</option>
...
<div class="col-md-4">
<label for="validationDefault07" class="form-label">Teléfono</label>
<input type="tel" class="form-control" name="telefono" id="validationDefault07" placeholder="">
</div>
<div class="col-md-4">
  <label for="validationDefault08" class="form-label">Estado</label>
...
<div class="col-md-4">
<label for="validationDefault09" class="form-label">Municipio</label>
<select class="form-select" name="municipio" id="validationCustom09" required>
  <option selected disabled value="">Selecciona...</option>
  <option>Acala</option>
...
<div class="col-md-4">
<label for="validationDefault10" class="form-label">Localidad</label>
<input type="text" class="form-control" name="localidad" id="validationDefault10" required>
</div>
<div class="col-md-4">
<label for="validationDefault11" class="form-label">CP</label>
<input type="text" class="form-control" name="cp" id="validationDefault11" required>
</div>
<div class="col-md-4">
<label for="validationDefault12" class="form-label">Dirección</label>
<input type="text" class="form-control" name="direccion" id="validationDefault12" placeholder="" required>
</div>
